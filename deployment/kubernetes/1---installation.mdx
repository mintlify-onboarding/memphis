...
If you prefer using **Terraform**, head [here](/memphis/deployment/cloud-deployment)
...
| websocket.tls.cert        | **\*Optional\***Memphis GUI using websockets for live rendering. .pem file to use                | ""            | "memphis\_local.pem"        |
| websocket.tls.key         | **\*Optional\***Memphis GUI using websockets for live rendering. key file                        | ""            | "memphis-key\_local.pem"    |
...
| nats.tls.cert             | **\*Optional\***For encrypted client-memphis communication. .pem file to use                     | ""            | "memphis\_client.pem"       |
| nats.tls.key              | **\*Optional\***For encrypted client-memphis communication. Private key file to use              | ""            | "memphis-key\_client.pem"   |
