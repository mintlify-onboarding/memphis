...
![](</memphis/images/Memphis%20Port%20Diagram.drawio%20(1).png>>)

## Memphis cluster component diagram (For production)

Full Kubernetes-based layout.

![](</memphis/images/Memphis%20Architecture%20(1).jpg>>)
...
![](/images/Deployment%20process.jpg)
...
- [Exactly once (Idempotence)](/memphis/memphis/concepts/idempotency)
