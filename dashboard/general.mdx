...
You can access the UI just after the installation of Memphis via K8S / Docker on your dev environment [here](/memphis/deployment/kubernetes).
...
For the full docker installation tutorial, please head [here](/memphis/deployment/docker-compose).
